...
public class HTMLEntitiesUtil {
     ...
     */
    private static final Object[][] htmlEntitiesTable = {
            { "&Aacute;", 193 },
            { "&aacute;", 225 },
            { "&Acirc;", 194 },
            { "&acirc;", 226 },
    ...
    private static void initializeEntitiesTables() {
        // Initialize HTML translation maps.
        for (Object[] objects : htmlEntitiesTable) {
            htmlEntitiesMap.put(objects[1], objects[0]);
            unHtmlEntitiesMap.put(objects[0], objects[1]);
        }
    }
        ...
        for (int i = 0; i < str.length(); ++i) {
            ...
            if (ch == '&') {
                ...
                if (entity.charAt(1) == '#') {
                    ...
                    iso = (Integer) unHtmlEntitiesMap.get(entity);
                }
