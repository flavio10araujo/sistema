...
public class EmailSendUtil {
	...
	public static void sendMessageCommunication(boolean async, int messageType, String to, String[] args) throws Exception {
		...
		if (messageType == 1) {
			...
			message = message + "<p><font face=\"arial\" size=\"2\"><br />Acesse <a href=\"https://" + resourceBundle.getString("email.url") + "\">" + resourceBundle.getString("email.url") + "</a> e continue estudando para subir de nível!</font></p></td></tr>";
