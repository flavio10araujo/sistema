...
public interface IAnswerRepository extends JpaRepository<Answer, Integer> {
	...
	public List<Answer> findByGame(@Param("gameId") int gameId);
	...
	public List<Answer> findByGameAndLevel(@Param("gameId") int gameId, @Param("levelId") int levelId);
	...
	public List<Answer> findByMap(@Param("mapId") int mapId);
	...
	public List<Answer> findByPhase(@Param("phaseId") int phaseId);
	
	@Query("SELECT answer FROM Answer answer, Question question WHERE answer.question = question.id AND question.id = :questionId")
	public List<Answer> findByQuestion(@Param("questionId") int questionId);
