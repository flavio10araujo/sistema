...
public class Error {
     ...
     * @param message the ws error description, i.e. invalid notification code value: {0}
     */
    ...
    /**
     * @param message the ws error description to set, i.e. invalid notification code value: {0}
     */
