...
public class ApplicationCredentials extends Credentials {
     ...
     *
     * @param productionAppId   the production application ID. Max length 60 characters.
     * @param productionAppKey  the production application Key. A sequence of 32 characters
     * @param sandboxAppId      the sandbox application ID. Max length 60 characters.
     * @param sandboxAppKey     the sandbox application Key. A sequence of 32 characters
     * @param authorizationCode the seller authorization code. A sequence of 32 characters
     */
     ...
     * Initializes a newly created instance of this type with the specified arguments
     *
     * @param appId             the application ID. Max length 60 characters.
     * @param appKey            the application key. A sequence of 32 characters
     * @param authorizationCode the seller authorization code. A sequence of 32 characters
     */
    ...
    /**
     * @param productionAppId the production application ID account to set. Max length 60 characters.
     */
    ...
    /**
     * @param sandboxAppId the sandbox application ID account to set. Max length 60 characters.
     */
    ...
    /**
     * @param productionAppkey the production application key account to set. Max length 32 characters.
     */
    ...
    /**
     * @param sandboxAppkey the sandbox application key account to set. Max length 32 characters.
     */
    ...
    /**
     * @param authorizationCode the authorization Code. Max length 30 characters.
     */
