...
public class AccountCredentials extends Credentials {
     ...
     * @param token the production pagseguro account security token. A sequence of 32 characters
     */
     ...
     *
     * @param email           the pagseguro email account. Max length 60 characters.
     * @param productionToken the production pagseguro account security token. A sequence of 32 characters
     * @param sandboxToken    the sandbox pagseguro account security token. A sequence of 32 characters
     */
    ...
    /**
     * @param token the account security token to set. A sequence of 32 characters
     */
