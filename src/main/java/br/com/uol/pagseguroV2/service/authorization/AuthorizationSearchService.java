package br.com.uol.pagseguroV2.service.authorization;
...
import br.com.uol.pagseguroV2.parser.authorization.AuthorizationParser;
import br.com.uol.pagseguroV2.service.ConnectionData;
import br.com.uol.pagseguroV2.service.TransactionSearchService;
...
public class AuthorizationSearchService {
     ...
     * @throws Exception
     */
    public static List<Authorization> searchByDate(Credentials credentials, Date initialDate, Date finalDate, int pageNumber, int resultsPerPage) throws
            PagSeguroServiceException {
